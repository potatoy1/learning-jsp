...
JSTL? Jsp Standard Tag Library
	...
	-jsp 페이지의 로직을 담당하는 부분인 if, for, while, DB처리 등과 관련된 코드를 
	JSTL로 대체하여 코드를 깔끔하고 가독성 좋게 할 수 있음.
	1) Core 태그(*******)
 ...
 --%>
	...
	-->
	<c:choose>
		<c:when test="${num2 % 2 == 0}">${num}은 짝수입니다</c:when>
		<c:when test="${num2 % 2 != 0}">${num}은 홀수입니다</c:when>
