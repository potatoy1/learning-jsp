...
<body>
	...
	<!-- ==================상품 목록 시작================== -->
	<div class="container">
		<div class="row" style="justify-content:right;margin:0 0 30px">
		<a href="addProduct.jsp" class="btn btn-primary" style="float:right;clear:both;">상품추가</a>
		</div>
		<div class="row" align="center">
			<!-- List<ProductVO>에서 한 행을 꺼내오면 ProductVO -->
			<c:forEach var="productVO" items="${listOfProducts}">
				<div class="col-md-4">
					<img alt="${productVO.pname}" title="${productVO.pname}" src="/resources/images/${productVO.filename}" style="width:100%;">
