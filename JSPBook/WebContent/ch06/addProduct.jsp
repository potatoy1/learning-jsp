	...
	<div class="container">
		...
		<form name="newProduct" action="processAddProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class = "form-group row">
				...
				<div class="col-sm-3">
				<textarea rows="2" cols="50" id="description" name="description" class="form-control"></textarea>
				</div>
			</div>
			<div class = "form-group row">
			...
			<div class = "form-group row">
				...
				<div class="col-sm-5">
					...
					<input type="radio" id="condition3" name="condition" value="Refurbished" /><fmt:message key="conditon_Refurbished" />
				</div>
			</div>
			 <div class="form-group row">
          	<label class = "col-sm-2"><fmt:message key="productImeage" /></label>
	            <div class="col-sm-5">
